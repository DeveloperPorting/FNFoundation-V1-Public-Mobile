...
class MiscSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		// var option:Option = new Option('Profanity (Audio only)',
		// 	'If unchecked, the songs will be replaced with versions that dont contain profanity (Does not apply to cutscenes and subtitles)',
		// 	'cursing',
		// 	'bool',
		// 	false);
		// addOption(option);
