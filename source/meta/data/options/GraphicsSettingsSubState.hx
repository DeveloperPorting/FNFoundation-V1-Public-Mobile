...
class GraphicsSettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Low Quality', //Name
			'If checked, disables some details,\ndecreases loading times and improves performance.', //Description
		...
		var option:Option = new Option('Shaders', // Name
			'If checked, allows the use of shaders. You may need to check this off if you are experiencing shader-related crashes.', // Description
		...
		var option:Option = new Option('Cutscenes', // Name
			'If checked, makes you see song cutscenes.', // Description
