...
import gameObjects.shader.FunkinShader;
	...
	public function new(parsed:Expr, ?name:String = "Script", ?additionalVars:Map<String, Any>)
	{
		...
		set("addHaxeLibrary", function(libName:String, ?libPackage:String = ''){
			try{
				...
				trace("Failed adding new library");
			}
		}); 
		...
		set("newShader", function(fragFile:String = null, vertFile:String = null){ // returns a FlxRuntimeShader but with file names lol
			var runtime:FunkinRuntimeShader = null;

			try{				
				runtime = new FunkinRuntimeShader(
			...
			return runtime==null ? new FunkinRuntimeShader() : runtime;
		});
		...
		set("MultiCharacter", MultiCharacter);
		...
		set("FoundationGameOverSubstate", meta.states.substate.FoundationGameOverSubstate);
		set("HealthIcon", HealthIcon);
		set("ComputerVoicelines", meta.data.ComputerVoicelines);
