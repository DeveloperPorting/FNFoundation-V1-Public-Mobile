...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		// DiscordClient.updatePresence("Chart Editor", StringTools.replace(_song.song, '-', ' '));
		DiscordClient.updatePresence("Editing " + StringTools.replace(_song.song, '-', ' '), "Chart Editor:");
		#end
