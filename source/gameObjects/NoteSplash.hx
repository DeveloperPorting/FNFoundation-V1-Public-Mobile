...
class NoteSplash extends FlxSprite
{
	...
	public function new(x:Float = 0, y:Float = 0, ?note:Int = 0) {
		...
		var skin:String = 'Foundationsplash';
	...
	function loadAnims(skin:String) {
		...
		switch(skin){
			case "Foundationsplash":
				animation.addByPrefix("note0-1", "LEFTsplash", 24, false);
				animation.addByPrefix("note1-1", "DOWNsplash", 24, false);
				animation.addByPrefix("note2-1", "UPsplash", 24, false);
				animation.addByPrefix("note3-1", "RIGHTsplash", 24, false);
				animation.addByPrefix("note4-1", "LEFTsplash", 24, false);

				animation.addByPrefix("note0-2", "LEFTsplash", 24, false);
				animation.addByPrefix("note1-2", "DOWNsplash", 24, false);
				animation.addByPrefix("note2-2", "UPsplash", 24, false);
				animation.addByPrefix("note3-2", "RIGHTsplash", 24, false);
				animation.addByPrefix("note4-2", "LEFTsplash", 24, false);
			case "notes/HarleyNOTE_splash":
				animation.addByPrefix("note0-1", "splash", 24, false);
				animation.addByPrefix("note1-1", "splash", 24, false);
				animation.addByPrefix("note2-1", "splash", 24, false);
				animation.addByPrefix("note3-1", "splash", 24, false);
				animation.addByPrefix("note4-1", "splash", 24, false);

				animation.addByPrefix("note0-2", "splash", 24, false);
				animation.addByPrefix("note1-2", "splash", 24, false);
				animation.addByPrefix("note2-2", "splash", 24, false);
				animation.addByPrefix("note3-2", "splash", 24, false);
				animation.addByPrefix("note4-2", "splash", 24, false);
			default:
