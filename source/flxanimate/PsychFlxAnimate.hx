/**
	CODE STOLEN FROM https://github.com/ShadowMario/FNF-PsychEngine/blob/main/source/flxanimate/PsychFlxAnimate.hx

	Stolen by: Xeight (@x8c8r), throw tomatoes at me I didn't feel like coding this myself, and I don't understand this either.
**/
